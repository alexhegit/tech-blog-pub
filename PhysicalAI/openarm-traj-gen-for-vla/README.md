...
![ginger 6-DOF 抓取-放置回放：升级到真实扫描物体](assets/gifs/ginger_full.gif)
...
![ginger 6-DOF pick-and-place replay: upgrading to a real scanned object](assets/gifs/ginger_full.gif)
