...
**AMD Instinct MI210 + ROCm** 平台上，用 [`openarm_mp_labs`](https://github.com/alexhegit/openarm_mp_labs)
...
![ginger 6-DOF 抓取-放置回放](assets/gifs/ginger_full.gif)

### 实践环境

- **硬件**：AMD Instinct **MI210**（本机 4 卡）
- **平台**：**ROCm 7.2**——容器内实测 `torch 2.7.1+rocm7.2`、`hip 7.2.26015`，4 卡全识别
...
![cube 抓-放回放](assets/gifs/cube_pickplace.gif)
...
3. **AMD ROCm 能扛 Physical AI**：从 GraspGenX 推理到 MuJoCo 数据生成，整条链路在 MI210 +
   ROCm 上跑得通。
...
and expensive. So we flip it: on an **AMD Instinct MI210 + ROCm** box, we turn OpenArm's
...
![ginger 6-DOF pick-and-place replay](assets/gifs/ginger_full.gif)

### Environment

- **Hardware**: AMD Instinct **MI210** (4 cards on this box)
- **Platform**: **ROCm 7.2** — measured `torch 2.7.1+rocm7.2`, `hip 7.2.26015`, all 4 detected
...
![cube pick-and-place replay](assets/gifs/cube_pickplace.gif)
